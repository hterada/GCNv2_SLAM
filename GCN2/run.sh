...
GCN_PATH=gcn2_320x240.pt ./rgbd_gcn ../Vocabulary/GCNvoc.bin TUM3_small.yaml \
/dataset/tum/rgbd_dataset_freiburg3_long_office_household \
/dataset/tum/rgbd_dataset_freiburg3_long_office_household/associations.txt
# ~/Workspace/Datasets/TUM/freiburg3/rgbd_dataset_freiburg3_long_office_household 
# ~/Workspace/Datasets/TUM/freiburg3/rgbd_dataset_freiburg3_long_office_household/associations.txt
